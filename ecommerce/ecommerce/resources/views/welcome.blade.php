    ...
    <body class="antialiased" style="min-width: 372px;">
        ...
        <main class="mb-5 pb-4">
            <div class="container">
                    ...
                    <div class="col-12 col-md-5 mt-2">
                        <form method="get" class="justify-content-center justify-content-md-start">
                            <div class="input-group">
                                <input type="text" id="search" class="form-control" placeholder="Oque você procura ?">
                ...
                <hr class="m-2">
                <div class="row">
                    <div class="col-12 col-xl-2 col-md-3 col-sm-4 d-flex align-items-stretch">
                    ...
                    </div><div class="col-12 col-xl-2 col-md-3 col-sm-4 d-flex align-items-stretch">
                        <div class="card mb-3" style="width: 18rem;">
                    ...
                    <div class="col-12 col-xl-2 col-md-3 col-sm-4 d-flex align-items-stretch">
                        ...
                        <div class="card mb-3" style="width: 18rem;">
                            <img class="card-img-top" src="/img/calcados/colcci_chinelo_verde.jpg" alt="Card image cap">
                            <div class="card-body">
                        ...
                        <div class="card mb-3" style="width: 18rem;">
                            <img class="card-img-top" src="/img/calcados/colcci_rosa.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Chinelo Colcci</h5>
                                <p class="card-text">R$ 65,00</p>
                                <a href="#" class="btn adc_carrinho">Adicionar ao carrinho</a>
